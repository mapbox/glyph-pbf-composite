...
tape('compositing two pbfs', function(t) {
    var composite = glyphs.combine([openSans512, arialUnicode512]);
    ...
    var recomposite = glyphs.combine([league512, composite]),
...
tape('can composite only one pbf', function(t) {
    var composite = glyphs.combine([openSans512]);
...
tape('can composite more than two', function(t) {
    var composite = glyphs.combine([league512, openSans512, arialUnicode512]);
